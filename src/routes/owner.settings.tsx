...
function OwnerSettingsPage() {
  ...
  const fetchSettings = async () => {
    ...
    try {
      ...
      setNamaBarbershop(data.barbershop.nama_barbershop || storeUser.barbershopName || "BARBERIN Barbershop");
      ...
      // Fallback to store
      setNamaBarbershop(storeUser.barbershopName || "BARBERIN Barbershop");
            ...
            <form onSubmit={handleSave} className="space-y-6">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div className="lg:col-span-5 space-y-6">
                  ...
                  {/* Card: Status Koneksi Database & Server */}
                  <div className="bg-[#0F1D33] border border-slate-800/80 rounded-2xl p-5 space-y-3 text-xs">
                    ...
                    <div className="space-y-2 text-slate-400">
                      <div className="flex justify-between py-1 border-b border-slate-800">
                        <span>Database</span>
                        <span className="text-emerald-400 font-medium">PostgreSQL (Connected)</span>
                      </div>
                      <div className="flex justify-between py-1 border-b border-slate-800">
                        <span>Sinkronisasi Store</span>
                        <span className="text-blue-400 font-medium">Realtime & Persisten</span>
                      </div>
                      <div className="flex justify-between py-1">
                        <span>Status Operasi</span>
                        <span className="text-white font-medium">Siap Melayani Pelanggan</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between bg-[#0F1D33] border border-slate-800 rounded-2xl p-4 shadow-lg">
                <div className="text-xs text-slate-400">
                  {isDirty ? (
                    ...
                    <span className="text-slate-400 flex items-center gap-1.5">
                      ...
                      Semua setelan tersimpan di database
                    </span>
                  )}
                </div>
                ...
                <div className="flex items-center gap-3">
                  {isDirty && (
                    <button
                      ...
                      onClick={handleReset}
                      disabled={saving || loading}
                      className="px-4 py-2 rounded-xl border border-slate-700 bg-slate-800 hover:bg-slate-700 text-slate-300 text-xs font-semibold flex items-center gap-1.5 transition-all"
                    >
                      <RotateCcw className="h-3.5 w-3.5" />
                      Batal
                    </button>
